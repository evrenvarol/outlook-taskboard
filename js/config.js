...
var config_data = {
  ...
  'GENERAL_CONFIG': {
    ...
    'BACKLOG_FOLDER':       { Name: '02_Backlog', Title: 'Backlog', Limit: 0, Sort: "-priority", Restrict: "[Complete] = false", Owner: '' },
    'INPROGRESS_FOLDER': 	{ Name: '04_InProgress', Title: 'Progress', Limit: 5, Sort: "-priority", Restrict: "[Complete] = false", Owner: ''},
    'NEXT_FOLDER': 			{ Name: '03_Next', Title: 'Next', Limit: 0, Sort: "duedate,-priority", Restrict: "[Complete] = false", Owner: ''},
    'FOCUS_FOLDER': 		{ Name: '06_Testing', Title: 'Testing', Limit: 0, Sort: "-priority", Restrict: "[Complete] = false or [Complete] = true", Owner: '' },
    'WAITING_FOLDER': 		{ Name: '05_Waiting', Title: 'Waiting', Limit: 0, Sort: "-priority", Restrict: "[Complete] = false", Owner: '' },
    'COMPLETED_FOLDER':     { Name: '07_Done', Title: 'Done', Limit: 0, Sort: "-priority", Restrict: "[Complete] = false or [Complete] = true", Owner: '' },
	// Not Visible, only used to move when done
    'ARCHIVE_FOLDER':       { Name: '08_Archive', Title: 'Done', Limit: 0, Sort: "-priority", Restrict: "[Complete] = false or [Complete] = true", Owner: '' },
