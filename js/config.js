...
var config_data = {
   ...
   'GENERAL_CONFIG': {
    ...
    'BACKLOG_FOLDER':       { Name: '', Title: 'TODO', Limit: 0, Sort: "-priority", Restrict: "[Status] = 'Not Started' And Not([Categories] = '!Next')", Owner: '' },
    'INPROGRESS_FOLDER': 	{ Name: '', Title: 'IN PROGRESS', Limit: 0, Sort: "-priority", Restrict: "[Status] = 'In Progress'", Owner: ''},
    'NEXT_FOLDER': 			{ Name: '', Title: 'NEXT', Limit: 0, Sort: "duedate,-priority", Restrict: "[Categories] = '!Next' AND [Status] = 'Not Started'" , Owner: ''},
    //'FOCUS_FOLDER': 		{ Name: 'Focus', Title: 'FOCUS', Limit: 0, Sort: "-priority", Restrict: "[Complete] = false", Owner: '' },
    'WAITING_FOLDER': 		{ Name: '', Title: 'WAITING', Limit: 0, Sort: "-priority", Restrict: "[Status] = 'Waiting on someone else'", Owner: '' },
    'COMPLETED_FOLDER':     { Name: '', Title: 'COMPLETED', Limit: 0, Sort: "-completeddate,-priority,subject", Restrict: "[Complete] = true " , Owner: '' },
